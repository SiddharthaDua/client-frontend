...
const WebHero = ({ onGetStarted }) => {
    const navigate = useNavigate();
    return (
        /* Added unique wrapper class: seo-hero-wrapper */
        <section className="web-hero-wrapper relative bg-gradient-to-br from-sky-50 via-white to-sky-100 py-24 px-6 overflow-hidden min-h-[600px] flex items-center">
            <div className="max-w-7xl mx-auto relative z-10 w-full">
                <div className="text-center">
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 mb-10 animate-fade-in-up delay-200 max-w-4xl mx-auto">
                        Professional website development services to help your business build credibility, attract customers, and grow online.
                    </p>
