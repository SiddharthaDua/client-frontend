...
const MetaHero = ({ onGetStarted }) => {
    const navigate = useNavigate();
    return (
        /* Added unique wrapper class: seo-hero-wrapper */
        <section className="meta-hero-wrapper relative bg-gradient-to-br from-sky-50 via-white to-sky-100 py-24 px-6 overflow-hidden min-h-[600px] flex items-center">
            <div className="max-w-7xl mx-auto relative z-10 w-full">
                <div className="text-center">
                    ...
                    <div className="inline-block bg-[#0ea5e9] text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 animate-fade-in-up">
                        🏆 High-Performance Meta Ads Agency
                    </div>
