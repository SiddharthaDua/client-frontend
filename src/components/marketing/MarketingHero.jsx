...
const MarketingHero = ({ onGetStarted }) => {
    const navigate = useNavigate();
    return (
        /* Added unique wrapper class: seo-hero-wrapper */
        <section className="marketing-hero-wrapper relative bg-gradient-to-br from-sky-50 via-white to-sky-100 py-24 px-6 overflow-hidden min-h-[600px] flex items-center">
            <div className="max-w-7xl mx-auto relative z-10 w-full">
                <div className="text-center">
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 mb-10 animate-fade-in-up delay-200 max-w-4xl mx-auto">
                        We help brands grow online through data-driven marketing strategies that increase visibility, generate leads, and boost sales.
                    </p>
